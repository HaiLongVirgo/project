                        ...
                        <div class="widget-item">
                            <div class="widget-title">
                                <div class="widget-logo">
                                    <a href="index.html">
                                        <img src="assets/img/anhlogo.png" alt="brand logo">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="widget-body">
                                <address class="contact-block">
                                    <ul>
                                        ...
                                        <li><i class="pe-7s-mail"></i> <a href="hailongvirgo@gmail.com">hailongvirgo@gmail.com </a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p>&copy; 2025 <b>Mô Hình</b> được thực hiện <i class="fa fa-heart text-danger"></i> bởi <a href="https://hasthemes.com/"><b>Nguyễn Hải Long</b></a></p>
                        </div>
                    </div>
                </div>
            </div>
