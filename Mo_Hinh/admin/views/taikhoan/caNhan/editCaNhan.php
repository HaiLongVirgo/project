            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="text-center">
                        <img src="<?= BASE_URL . $thongTin['anh_dai_dien'] ?>" style="width: 100px" class="avatar img-circle" alt="avatar" onerror="this.onerror=null; this.src='https://static.vecteezy.com/system/resources/previews/008/442/086/non_2x/illustration-of-human-icon-user-symbol-icon-modern-design-on-blank-background-free-vector.jpg'">
                ...
                <div class="col-md-9 personal-info">
                    ...
                    <?php if (isset($_SESSION['success'])) { ?>
                        <div class="alert alert-info alert-dismissble">
                            <a class="panel-close close" data-dismiss="alert" href="">X</a>
                            <i class="fa fa-conffee"></i>
                            <?= $_SESSION['success'] ?>
                        </div>
                    <?php } ?>
                    <form action="<?= BASE_URL_ADMIN . '?act=sua-mat-khau-thong-tin-ca-nhan-quan-tri' ?>" method="post">
                        <div class="form-group">
